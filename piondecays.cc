...
int main(int argc, char** argv ) {
  ...
  HepMC::IO_GenEvent ascii_io("piondecays.dat", std::ios::out);
  ...
  for (int iEvent = 0; iEvent < nEvent; ++iEvent) {
    ...
    if (type == 0 || type == 11) fillParticle( idGun, eeGun, theta, phi,
